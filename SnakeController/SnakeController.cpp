...
void Controller::checkSnakeCollision(Segment& newHead, bool& lost)
{
...
void Controller::castFoodInd(EventT<FoodInd> e) 
{
    auto receivedFood = *e;
...
void Controller::castFoodResp(EventT<FoodResp> e) 
{
...
void Controller::receive(std::unique_ptr<Event> e)
{
    try {
        ...
        try {
            ...
            try {
                castFoodInd(*dynamic_cast<EventT<FoodInd> const&>(*e));
            } catch (std::bad_cast&) {
                try {
                    castFoodResp(*dynamic_cast<EventT<FoodResp> const&>(*e));
                } catch (std::bad_cast&) {
